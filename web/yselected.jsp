                ...
                <ul class="nav justify-content-end">
                    <li class="nav-item">
                        <div class="head">
                            <!--
                            <div class="head1">
                                <img src="images/用户端主页/u10.png" width=30 height=30 />
                            </div>
                            <div class="head2">
                                <img src="images/首页/u2.png" width=180 height=30 />
                            </div>
                            -->
                        </div>
                    </li>
...
<center>
    ...
    <%
        ...
        session.setAttribute("yuan", yname);
        try {

            PreparedStatement sql = DB.dbCon().prepareStatement("SELECT * FROM yuan where yname=?");

            sql.setString(1, yname);
            rs = sql.executeQuery();
            if (rs.next()) {
